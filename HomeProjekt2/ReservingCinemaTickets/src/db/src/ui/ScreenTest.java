...
public class ScreenTest extends JFrame {
	...
	public ScreenTest(ArrayList<CinemaTheater> TheaterForCurenMovieList) {
		...
		// JButton btnListTheater = new
		// JButton(TheaterForCurenMovieList.get(1).getName());
		// btnListTheater.setBounds(24, 151, 200, 35);
		// btnListTheater.addMouseListener(new MouseAdapter() {
		// @Override
		// public void mouseEntered(MouseEvent e) {
		// btnListTheater.setBackground(Color.GRAY);
		// }
		// @Override
		// public void mouseExited(MouseEvent e) {
		// btnListTheater.setBackground(Color.WHITE);
		// }
		// });
		//
		// JPopupMenu popupMenu = new JPopupMenu();
		// popupMenu.setBounds(23, 5, 115, 21);
		// addPopup(contentPane, popupMenu);
		// contentPane.setLayout(null);
		// btnListTheater.setBackground(Color.WHITE);
		// btnListTheater.setToolTipText("Кликни за да избереш");
		// contentPane.add(btnListTheater);
		//
		//
