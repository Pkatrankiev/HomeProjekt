...
import db.Movie;
	...
	public class ListTimeForCurentDateScreen1 extends JFrame {

		private JPanel contentPane;
		public ListTimeForCurentDateScreen1(int x, int y, 
...
//		contentPane.add(lblNewLabel_1);
			...
			public void ListTimeForCurentDateScreen(int x, int y, 
					Date[] listTime,int countListTime) {
